...
static HerDeviceMemoryPool<float, float> pool_s;
static HerDeviceMemoryPool<double, double> pool_d;
static HerDeviceMemoryPool<std::complex<float>, std::complex<float>> pool_c;
static HerDeviceMemoryPool<std::complex<double>, std::complex<double>> pool_z;
