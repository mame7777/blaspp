...
// -----------------------------------------------------------------------------
// Memory pool for batch SYR2K device tests
template <typename TA, typename TB, typename TC>
struct BatchSyr2kDeviceMemoryPool {
...
static BatchSyr2kDeviceMemoryPool<float, float, float> pool_float;
static BatchSyr2kDeviceMemoryPool<double, double, double> pool_double;
static BatchSyr2kDeviceMemoryPool<std::complex<float>, std::complex<float>, std::complex<float>> pool_complex_float;
static BatchSyr2kDeviceMemoryPool<std::complex<double>, std::complex<double>, std::complex<double>> pool_complex_double;

// Helper function to get the appropriate pool
template <typename TA, typename TB, typename TC>
BatchSyr2kDeviceMemoryPool<TA, TB, TC>& get_pool() {
