...
// -----------------------------------------------------------------------------
// Memory pool for batch HEMM device tests
template <typename TA, typename TB, typename TC>
struct BatchHemmDeviceMemoryPool {
...
static BatchHemmDeviceMemoryPool<float, float, float> pool_float;
static BatchHemmDeviceMemoryPool<double, double, double> pool_double;
static BatchHemmDeviceMemoryPool<std::complex<float>, std::complex<float>, std::complex<float>> pool_complex_float;
static BatchHemmDeviceMemoryPool<std::complex<double>, std::complex<double>, std::complex<double>> pool_complex_double;

// Helper function to get the appropriate pool
template <typename TA, typename TB, typename TC>
BatchHemmDeviceMemoryPool<TA, TB, TC>& get_pool() {
