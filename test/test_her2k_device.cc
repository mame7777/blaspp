...
static Her2kDeviceMemoryPool<float, float, float> pool_s;
static Her2kDeviceMemoryPool<double, double, double> pool_d;
static Her2kDeviceMemoryPool<std::complex<float>, std::complex<float>, std::complex<float>> pool_c;
static Her2kDeviceMemoryPool<std::complex<double>, std::complex<double>, std::complex<double>> pool_z;
...
void test_her2k_device_work( Params& params, bool run )
{
    ...
    Her2kDeviceMemoryPool<TA, TB, TC>* pool;
    if (std::is_same<TA, float>::value) {
        pool = reinterpret_cast<Her2kDeviceMemoryPool<TA, TB, TC>*>(&pool_s);
    }
    else if (std::is_same<TA, double>::value) {
        pool = reinterpret_cast<Her2kDeviceMemoryPool<TA, TB, TC>*>(&pool_d);
    }
    else if (std::is_same<TA, std::complex<float>>::value) {
        pool = reinterpret_cast<Her2kDeviceMemoryPool<TA, TB, TC>*>(&pool_c);
    }
    else {
        pool = reinterpret_cast<Her2kDeviceMemoryPool<TA, TB, TC>*>(&pool_z);
    }
