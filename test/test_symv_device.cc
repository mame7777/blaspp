...
static SymvDeviceMemoryPool<float, float, float> pool_s;
static SymvDeviceMemoryPool<double, double, double> pool_d;
static SymvDeviceMemoryPool<std::complex<float>, std::complex<float>, std::complex<float>> pool_c;
static SymvDeviceMemoryPool<std::complex<double>, std::complex<double>, std::complex<double>> pool_z;
...
void test_symv_device_work( Params& params, bool run )
{
    ...
    if (std::is_same<TA, float>::value && std::is_same<TX, float>::value && std::is_same<TY, float>::value) {
        ...
        pool = reinterpret_cast<SymvDeviceMemoryPool<TA, TX, TY>*>(&pool_c);
        ...
        pool = reinterpret_cast<SymvDeviceMemoryPool<TA, TX, TY>*>(&pool_z);
    }
