...
// -----------------------------------------------------------------------------
// Memory pool for batch SYMM device tests
template <typename TA, typename TB, typename TC>
struct BatchSymmDeviceMemoryPool {
...
static BatchSymmDeviceMemoryPool<float, float, float> pool_float;
static BatchSymmDeviceMemoryPool<double, double, double> pool_double;
static BatchSymmDeviceMemoryPool<std::complex<float>, std::complex<float>, std::complex<float>> pool_complex_float;
static BatchSymmDeviceMemoryPool<std::complex<double>, std::complex<double>, std::complex<double>> pool_complex_double;

// Helper function to get the appropriate pool
template <typename TA, typename TB, typename TC>
BatchSymmDeviceMemoryPool<TA, TB, TC>& get_pool() {
