...
// -----------------------------------------------------------------------------
// Memory pool for batch TRSM device tests
template <typename TA, typename TB>
struct BatchTrsmDeviceMemoryPool {
...
static BatchTrsmDeviceMemoryPool<float, float> pool_float;
static BatchTrsmDeviceMemoryPool<double, double> pool_double;
static BatchTrsmDeviceMemoryPool<std::complex<float>, std::complex<float>> pool_complex_float;
static BatchTrsmDeviceMemoryPool<std::complex<double>, std::complex<double>> pool_complex_double;

// Helper function to get the appropriate pool
template <typename TA, typename TB>
BatchTrsmDeviceMemoryPool<TA, TB>& get_pool() {
