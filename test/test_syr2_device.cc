...
static Syr2DeviceMemoryPool<float, float, float> pool_s;
static Syr2DeviceMemoryPool<double, double, double> pool_d;
static Syr2DeviceMemoryPool<std::complex<float>, std::complex<float>, std::complex<float>> pool_c;
static Syr2DeviceMemoryPool<std::complex<double>, std::complex<double>, std::complex<double>> pool_z;
...
void test_syr2_device_work( Params& params, bool run )
{
    ...
    if (std::is_same<TA, float>::value && std::is_same<TX, float>::value && std::is_same<TY, float>::value) {
        ...
        pool = reinterpret_cast<Syr2DeviceMemoryPool<TA, TX, TY>*>(&pool_c);
        ...
        pool = reinterpret_cast<Syr2DeviceMemoryPool<TA, TX, TY>*>(&pool_z);
    }
