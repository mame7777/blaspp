...
// -----------------------------------------------------------------------------
// Memory pool for batch GEMM device tests
template <typename TA, typename TB, typename TC>
struct BatchGemmDeviceMemoryPool {
...
static BatchGemmDeviceMemoryPool<float, float, float> pool_float;
static BatchGemmDeviceMemoryPool<double, double, double> pool_double;
static BatchGemmDeviceMemoryPool<std::complex<float>, std::complex<float>, std::complex<float>> pool_complex_float;
static BatchGemmDeviceMemoryPool<std::complex<double>, std::complex<double>, std::complex<double>> pool_complex_double;

// Helper function to get the appropriate pool
template <typename TA, typename TB, typename TC>
BatchGemmDeviceMemoryPool<TA, TB, TC>& get_pool() {
