...
static AxpyDeviceMemoryPool<float, float> pool_s;
static AxpyDeviceMemoryPool<double, double> pool_d;
static AxpyDeviceMemoryPool<std::complex<float>, std::complex<float>> pool_c;
static AxpyDeviceMemoryPool<std::complex<double>, std::complex<double>> pool_z;
